...
def show_loss_acc(history):
    ...
    plt.xlabel('epoch')
    plt.savefig('results/results_Inception_v3_epoch_30.png', dpi=100)
...
def train(epochs):
    ...
    train_ds, val_ds, class_names = data_load(r"D:\Python\PythonProject\Truck_identification\new_data\train",
    ...
    model.save("models/Inception_v3_epoch_30.h5")
    # 记录结束时间
    end_time = time()
