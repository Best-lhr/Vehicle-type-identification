...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowIcon(QIcon('images/city_trafic.jpg'))
        self.setWindowTitle('基于卷积神经网络的车型分类系统')
        # 模型初始化
        self.model = tf.keras.models.load_model(r"D:\Python\PythonProject\Truck_identification\models\ResNet_best.h5")  # todo 修改模型名称
        self.to_predict_name = "images/truck.jpg"
        self.class_names = ['卡车', '小车']
        self.resize(900, 700)
        self.initUI()
    ...
    def initUI(self):
        ...
        about_title = QLabel('欢迎使用车型分类识别系统')
        about_title.setFont(QFont('楷体', 18))
        about_title.setAlignment(Qt.AlignCenter)
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/city_trafic.jpg'))
        about_img.setAlignment(Qt.AlignCenter)
        label_super = QLabel("作者：lhr")
