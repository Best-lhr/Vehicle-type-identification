...
def model_load(IMG_SHAPE=(224, 224, 3), class_num=2):
    ...
    # unit 1
    tf.keras.layers.Conv2D(64, kernel_size=[3, 3], padding="same", activation=tf.nn.relu, input_shape=IMG_SHAPE),
...
def show_loss_acc(history):
    ...
    plt.xlabel('epoch')
    plt.savefig('results/results_VGGNet.png', dpi=100)
