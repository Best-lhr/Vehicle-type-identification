...
def test_Inception_v3():
    ...
    train_ds, test_ds, class_names = data_load(r"D:\Python\PythonProject\Truck_identification\new_data\train",
                                              r"D:\Python\PythonProject\Truck_identification\new_data\test", 224, 224, 16)
    # todo 加载模型，修改为你的模型名称
    model = tf.keras.models.load_model(r"D:\Python\PythonProject\Truck_identification\models\Inception_v3_epoch_30.h5")
    # model.summary()
    # 测试
    loss, accuracy = model.evaluate(test_ds)
    # 输出结果
    print('Inception_v3 test accuracy :', accuracy)
    ...
    show_heatmaps(title="heatmap", x_labels=class_names, y_labels=class_names, harvest=heat_maps_float,
                  save_name="results/heatmap_Inception_v3_epoch_30.png")
